...
Semantic + skills + exp. & Partial & 0.287 & 0.933 & 0.961 & 0.917 & 0.866 \\
...
\end{tabular}
\par\vspace{0.4em}
\footnotesize{Source: \texttt{2026-05-27T150000Z/ablation/ablation\_summary.json}. Weights for full composite in this run: semantic 40\%, skills 30\%, experience 15\%, compensation 10\%, location 5\% (no title term). \todo{Re-run with portal weights 28/27/10/15/10/10.}}
