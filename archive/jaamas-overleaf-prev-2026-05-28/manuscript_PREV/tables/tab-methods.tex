...
\end{tabular}
\par\vspace{0.4em}
\footnotesize{Source: research pipeline run \texttt{2026-05-27T150000Z/comparison/comparison\_summary.json}. Exhaustive ranking over all 15 jobs per query. Latency in Table~\ref{tab:latency}.}
