...
| nationality_phrase_01 | summary_suffix | Yes | 5/5 | 1 | 0.0061 | Yes |
| nationality_phrase_02 | summary_suffix | Yes | 5/5 | 1 | 0.0077 | No |
...
*Note: Synthetic counterfactual pairs only (10 pairs). 7 flagged under score-delta and rank-stability thresholds. No protected attributes inferred from real users.*
