...
\end{tabular}
\par\vspace{0.4em}
\footnotesize{Source: research pipeline run \path{2026-05-27T150000Z/comparison/comparison_summary.json}. Exhaustive ranking over all 15 jobs per query. Latency appears in Table~\ref{tab:latency}.}
