...
\end{tabular}
\par\vspace{0.4em}
\footnotesize{Latency from \texttt{comparison\_summary.json}, \texttt{cross\_encoder\_report.json}, and \texttt{phase11\_summary.csv} (ANN, pool${=}10$, Chroma). Exhaustive scoring vs.\ ANN shortlist on the 15-job pool; per-query latencies are small and noisy at this scale.}
