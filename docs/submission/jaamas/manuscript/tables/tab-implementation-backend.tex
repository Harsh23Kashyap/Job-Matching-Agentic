...
Candidate agent & \path{agents/candidate_agent.py}, \path{hooks/parser.py} & Parses resumes, versions candidate snapshots, embeds canonical text, and upserts to \texttt{candidates\_collection}. \\
