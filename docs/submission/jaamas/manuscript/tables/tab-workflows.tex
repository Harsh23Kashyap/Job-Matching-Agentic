...
Admin & \texttt{/admin/console} & Monitor agents, run matches, inspect fairness & \texttt{GET /agents/status}, \texttt{/agents/events/recent}, \texttt{/system/config}; optional \texttt{/match/*} and \texttt{/system/fairness} \\
\bottomrule
\end{tabular}
\normalsize
\par\vspace{0.4em}
