...
Reciprocal rank fusion (RRF) combines ranked outputs using reciprocal rank weights and is robust when individual retrievers make complementary errors~\cite{Cormack2009}.
