...
A résumé and a job snapshot pass through embedding similarity, skill overlap, and the experience, compensation, and remote signals, which combine into a weighted composite score and a structured explanation that drives the ranked recommendation.
...
The semantic score compares résumé and job-description embeddings.
...
The skill score compares résumé skills against job requirements.
