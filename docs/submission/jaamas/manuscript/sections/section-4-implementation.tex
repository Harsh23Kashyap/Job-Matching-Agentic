...
\begin{JTable}
\input{tables/tab-implementation-backend.tex}
\end{JTable}
...
\begin{itemize}[leftmargin=*]
  \item \textbf{Candidate:} \texttt{/candidates/me/*}, resume upload, saved jobs, applications, and \texttt{/similar/jobs/*}.
...
\centering
\JFigFramed{\includegraphics[width=0.99\linewidth,height=0.30\textheight,keepaspectratio]{../figures/screenshots/ui-candidate-matches.png}}\\[3pt]
{\small (a) Candidate job matches}
\end{minipage}\\[0.65\baselineskip]
\begin{minipage}{0.98\linewidth}
\centering
\JFigFramed{\includegraphics[width=0.99\linewidth,height=0.30\textheight,keepaspectratio]{../figures/screenshots/ui-employer-matches.png}}\\[3pt]
{\small (b) Employer reverse search}
\end{minipage}\\[0.65\baselineskip]
\begin{minipage}{0.98\linewidth}
\centering
\JFigFramed{\includegraphics[width=0.99\linewidth,height=0.36\textheight,keepaspectratio]{../figures/screenshots/ui-score-breakdown.png}}\\[3pt]
...
\begin{JTable}
\input{tables/tab-implementation-contracts.tex}
\end{JTable}
...
\begin{table}[!htbp]
\centering
\input{tables/tab-implementation-params.tex}
\end{table}
...
\begin{table}[!htbp]
\centering
\input{tables/tab-implementation-repro.tex}
\end{table}
